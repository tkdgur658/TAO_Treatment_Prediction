...
def train_epoch_nsr(model, para_model, optimizer, scaler, criterion, args, data_config, distributed_run, device, epoch, total_iter, train_loader ) :    
...
def sample_epoch_infer_nsr(model, para_model, scaler, args,  args_data, distributed_run, device, epoch, valid_loader ) :  
    import os 
    import torch 
